...
Attribute Attribute::of(unsigned short count, AttributeType type, Normalization normalization) {
...
Attribute::Attribute(unsigned short count, AttributeType type, Normalization normalization) : count(count), type(type), typeSize(getTypeSize(type)), normalization(normalization) {
